...
- Tier assignments (Always / Complete / Never) are set by the user during onboarding and locked in for tracking consistency
...
- Tier assignment (Always / Complete / Never) — defaults to Always
...
*To be decided in a separate session before build begins.*

Working assumptions:
- Safety question (Q42): Always — locked, cannot be changed
- Free-form entries (Q43–Q45): Always
- Section 8 (Work & Commitments): conditional on onboarding, not tiered in the same way
- Everything else: TBD
...
- Default tier assignments for all questions
